...
const REFERRAL_CODE = args[0]; // Kode referral dari command line
const ACCOUNT_COUNT = parseInt(args[1], 10) || 1; // Jumlah akun yang ingin dibuat, default 1 jika tidak diisi
